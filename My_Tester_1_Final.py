...
if __name__ == "__main__":
    ...
    model.load_state_dict(torch.load("E://VS Projects//test_24-3-2025_FC - Testing WHU dataset 256//checkpoints//checkpoint3-50epochs//ResUnet46.pth"))
    model.eval()
    test_results_path="E://VS Projects//test_24-3-2025_FC - Testing WHU dataset 256//test results//test_results3-50epochs"
    ...
    with torch.no_grad():
        for _, data in enumerate(test_loader):
            ...
            prediction = torch.where(probs> 0.4, 1.0,0.0)
