...
model1 = Unet(input_nbr=6, label_nbr=1)
model1=model1.to(device)
model1.load_state_dict(torch.load("E://VS Projects//test_24-3-2025_FC - Testing WHU dataset 256//checkpoints//checkpoint3-50epochs//ResUnet46.pth"))
model1.eval()
